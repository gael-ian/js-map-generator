/*
 * map.draw.tridimensional.proportional
 */
map.draw.projection.tridimensional.proportional = function(drawer) {
  this.drawer = drawer;
  ...
  this.z = function(location) {
    return location.elevation + location.point.context.radius;
  };
}; 
